...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-[#8000b2]/20 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="text-white/40 text-sm flex items-center gap-1.5">
          Built with <Heart className="h-3.5 w-3.5 text-[#8000b2] fill-[#8000b2]" /> by <span className="text-[#8000b2] font-bold">Anumitha V</span>
        </motion.p>
