  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none select-none" aria-hidden>
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(rgba(14, 116, 144,0.9) 1px, transparent 1px)",
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle at 35% 35%, rgba(14, 116, 144,0.09), transparent 65%)" }}
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle at 65% 65%, rgba(14, 116, 144,0.07), transparent 65%)" }}
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, rgba(14, 116, 144,0.04), transparent 70%)" }}
      ...
      <motion.div
        ...
        style={{ background: "linear-gradient(90deg, transparent, rgba(14, 116, 144,0.18) 40%, rgba(14, 116, 144,0.18) 60%, transparent)" }}
